...
var ListsResolver = /** @class */ (function () {
    function ListsResolver(userService, router, alertify) {
        ...
        this.pageNumber = 1;
        this.pageSize = 5;
        this.likesParam = 'Likers'; // List of users that like current user
    }
...
var MemberCardComponent = /** @class */ (function () {
    ...
    MemberCardComponent.prototype.sendLike = function (id) {
        var _this = this;
        this.userService.sendLike(this.authService.decodedToken.nameid, id).subscribe(function () {
...
var MemberListComponent = /** @class */ (function () {
    ...
    MemberListComponent.prototype.applyFilter = function () {
        this.pagination.currentPage = 1;
        this.loadUsers();
    };
...
var MemberMessagesComponent = /** @class */ (function () {
    ...
    MemberMessagesComponent.prototype.loadMessages = function () {
        var _this = this;
        var currentUserId = +this.authService.decodedToken.nameid; // number
    ...
    MessagesComponent.prototype.deleteMessage = function (id) {
        ...
        this.alertify.confirm('Are you sure you want to delete this message?', function () {
            _this.userService.deleteMessage(id, _this.authService.decodedToken.nameid)
                ...
                _this.alertify.success('Message deleted successfully!');
            }, function (error) {
    ...
    RegisterComponent.prototype.register = function () {
        ...
        if (this.registerForm.valid) {
            ...
            this.authService.register(this.user).subscribe(function () {
                _this.alertify.success('Registrations successful.');
            }, function (error) {
                _this.alertify.error(error);
            }, function () {
...
module.exports = __webpack_require__(/*! C:\dev\_private\FakeTinder\src\FakeTinder-SPA\src\main.ts */"./src/main.ts");
